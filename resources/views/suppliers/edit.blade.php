...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row justify-content-center mt-2">
            <p class="text-primary h2">Editar Proveedor</p>
        </div>
        <div class="mt-4">
            <form method="POST" action="{{ url('suppliers/'. $record->id) }}" enctype="multipart/form-data"
                ...
                <div class="form-row">
                    <div class="col-12 input-group input-group-lg mb-3">
                        ...
                        <input id="name" placeholder="Proveedor" type="text"
                            ...
                            value="{{ $record->name }}" required autofocus>
