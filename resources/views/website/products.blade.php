...
@section('content')
        ...
        <section id="team" class="pb-5">
            <div class="container">
                <h5 class="section-title h1">
                    <img src="{{ asset('img/microsoft-logo.png') }}" class="mx-auto d-inline" height="150px">
                </h5>
                <div class="row">
                                    ...
                                    <div class="backside">
                                        <div class="card">
                                            <div class="card-body text-center mt-4">
                                                <h4 class="card-title">{{ $item->title }}</h4>
                                                <p class="card-text">{{ $item->information }}
                                                </p>
                                                <a href="{{ url('#') }}" class="btn btn-primary"> <i class="fa fa-plus text-light">
                                                    </i> </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                            <div class="mainflip">
                                ...
                                <div class="backside">
                                    <div class="card">
                                        <div class="card-body text-center mt-4">
                                            <h4 class="card-title">Active Directory</h4>
                                            <p class="card-text">This is basic card with image on top, title, description
                                                and button.This is basic card with image on top, title, description and
                                                button.This is basic card with image on top, title, description and button.
                                            </p>
                        ...
                        <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                            <div class="mainflip">
                                ...
                                <div class="backside">
                                    <div class="card">
                                        <div class="card-body text-center mt-4">
                                            <h4 class="card-title">Dynamics 365</h4>
                                            <p class="card-text">This is basic card with image on top, title, description
                                                and button.This is basic card with image on top, title, description and
                                                button.This is basic card with image on top, title, description and button.
                                            </p>
    ...
    <div>
        ...
        <section id="team" class="pb-5">
            <div class="container">
                <h5 class="section-title h1">
                    <img src="{{ asset('img/sap.png') }}" class="mx-auto d-inline" height="90px">
                </h5>
                <div class="row">
                    <!-- Team member -->
                    <div class="col-xs-12 col-sm-6 col-md-4">
