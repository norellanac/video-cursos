			...
			<div class="container">
				<div class="row flexbox-center">
					<div class="col-lg-2 col-md-3 col-6">
						<div class="logo">
							<a href="#home"><img src="{{asset('prantokon/img/logo.png')}}" alt="logo" /></a>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-5">
					    <div class="hand-mockup text-lg-left text-center">
							<img src="{{asset('prantokon/img/hand-mockup.png')}}" alt="Hand Mockup" />
						</div>
					</div>
				</div>
			</div>
		...
		<section class="about-area ptb-90">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <div class="sec-title">
							<h2>About {{ config('app.name', 'Jalón |Raite') }}<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-4">
						<div class="single-feature-box text-center">
							<img src="{{asset('prantokon/img/feature.png')}}" alt="feature">
						</div>
					</div>
					<div class="col-lg-4">
		...
		<section class="showcase-area ptb-90">
			<div class="container">
				...
				<div class="row flexbox-center">
					...
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="{{asset('prantokon/img/showcase.png')}}" alt="showcase">
						</div>
					</div>
				</div>
				<div class="row flexbox-center">
					<div class="col-lg-6">
						<div class="single-showcase-box">
							<img src="{{asset('prantokon/img/showcase2.png')}}" alt="showcase">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="single-showcase-box">
					...
					<div class="col-lg-12">
						<div class="screenshot-wrap">
							<div class="single-screenshot">
								<img src="{{asset('prantokon/img/screenshot/screenshot1.jpg')}}" alt="screenshot" />
							</div>
							<div class="single-screenshot">
								<img src="{{asset('prantokon/img/screenshot/screenshot2.jpg')}}" alt="screenshot" />
							</div>
							<div class="single-screenshot">
								<img src="{{asset('prantokon/img/screenshot/screenshot3.jpg')}}" alt="screenshot" />
							</div>
							<div class="single-screenshot">
								<img src="{{asset('prantokon/img/screenshot/screenshot4.jpg')}}" alt="screenshot" />
							</div>
							<div class="single-screenshot">
								<img src="{{asset('prantokon/img/screenshot/screenshot5.jpg')}}" alt="screenshot" />
							</div>
						</div>
					</div>
				</div>
						...
						<div class="testimonial-wrap">
							<div class="single-testimonial-box">
								<div class="author-img">
									<img src="{{asset('prantokon/img/author/author1.jpg')}}" alt="author" />
								</div>
								<h5>Mary Balogh</h5>
							...
							<div class="single-testimonial-box">
								<div class="author-img">
									<img src="{{asset('prantokon/img/author/author2.jpg')}}" alt="author" />
								</div>
								<h5>Mary Balogh</h5>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi  aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in </p>
								<div class="author-rating">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
					    <div class="single-team-member">
							<div class="team-member-img">
								<img src="{{asset('prantokon/img/team/team1.jpg')}}" alt="team">
					...
					<div class="col-lg-3 col-sm-6">
					    <div class="single-team-member">
							<div class="team-member-img">
								<img src="{{asset('prantokon/img/team/team2.jpg')}}" alt="team">
								<div class="team-member-icon">
									<div class="display-table">
										<div class="display-tablecell">
											<a href="#"><i class="icofont icofont-social-facebook"></i></a>
					...
					<div class="col-lg-3 col-sm-6">
					    <div class="single-team-member">
							<div class="team-member-img">
								<img src="{{asset('prantokon/img/team/team3.jpg')}}" alt="team">
								<div class="team-member-icon">
									<div class="display-table">
										<div class="display-tablecell">
											<a href="#"><i class="icofont icofont-social-facebook"></i></a>
					...
					<div class="col-lg-3 col-sm-6">
					    <div class="single-team-member">
							<div class="team-member-img">
								<img src="{{asset('prantokon/img/team/team4.jpg')}}" alt="team">
								<div class="team-member-icon">
									<div class="display-table">
										<div class="display-tablecell">
											<a href="#"><i class="icofont icofont-social-facebook"></i></a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
					    <div class="single-post">
							<div class="post-thumbnail">
								<a href="blog.html"><img src="{{asset('prantokon/img/blog/blog1.jpg')}}" alt="blog"></a>
							</div>
					...
					<div class="col-lg-4 col-md-6">
					    <div class="single-post">
							<div class="post-thumbnail">
								<a href="blog.html"><img src="{{asset('prantokon/img/blog/blog2.jpg')}}" alt="blog"></a>
							</div>
							<div class="post-details">
								<div class="post-author">
									<a href="blog.html"><i class="icofont icofont-user"></i>John</a>
					...
					<div class="col-lg-4 d-md-none d-lg-block">
					    <div class="single-post">
							<div class="post-thumbnail">
								<a href="blog.html"><img src="{{asset('prantokon/img/blog/blog3.jpg')}}" alt="blog"></a>
							</div>
							<div class="post-details">
								<div class="post-author">
									<a href="blog.html"><i class="icofont icofont-user"></i>John</a>
