...
<head>
    <title>Cliente solicitando informacion</title>
        ...
        <tr>
            <td align="center" valign="top" bgcolor="#30373b">
                <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table"
                    ...
                    <tr>
                        <td style="line-height:0px; font-size:0px;" width="600" class="em_hide" bgcolor="#30373b"><img
                                src="images/spacer.gif" height="1" width="600"
                                                    ...
                                                    <table width="150" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="right" class="em_align_cent1"
                                                                style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:16px; color:#848789; text-decoration:underline;">
                                                                <a href="#" target="_blank"
                                                                    style="text-decoration:underline; color:#848789;">Ver
                                                                    Cartera
                                                                    clientes</a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table width="400" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="left" class="em_align_cent"
                                                                style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789; text-decoration:none;">
                                                                Clientes desde sitio web
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table"
                    ...
                    <tr>
                        <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img
                                    src="http://pctecbus.co/pctecbus/img/pc-technology.png" width="230" height="80"
                    ...
                    <tr>
                        <td align="center"
                            ...
                            class="em_font">
                            <a href="#" target="_blank" style="text-decoration:none; color:#30373b;">{{ $request->solution }}</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" target="_blank"
                                style="text-decoration:none; color:#30373b;">{{ $request->rating }}</a><span class="em_hide">
                                &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; </span><span class="em_br"></span><a
                                href="#" target="_blank" style="text-decoration:none; color:#30373b;">{{ $request->industry }}</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" target="_blank"
                                style="text-decoration:none; color:#30373b;">{{ $request->product }}</a>
                        </td>
                    </tr>
                    <tr>
                        <td height="14" style="font-size:1px; line-height:1px;">&nbsp;</td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td valign="middle" align="center"><img
                                            src="https://image.shutterstock.com/image-vector/two-businessmen-communicate-each-other-260nw-754173427.jpg"
                                            width="333" height="303" alt="WELCOME"
                                            style="display:block; font-family:Arial, sans-serif; font-size:25px; line-height:303px; color:#c27cbb;max-width:333px;"
                                            class="em_full_img" border="0" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center"
                                        style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">
                                        {{ $request->name }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center"
                                        style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:20px; color:#feae39;">
                                        <a href="emailto:{{ $request->email }}">{{ $request->email }}</a></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <span style="text-decoration:underline;"><a href="#" target="_blank"
                                    style="text-decoration:underline; color:#848789;">PRIVACY STATEMENT</a></span>
                            &nbsp;&nbsp;|&nbsp;&nbsp; <span style="text-decoration:underline;"><a href="#"
                                    target="_blank" style="text-decoration:underline; color:#848789;">TERMS OF
                                    SERVICE</a></span><span class="em_hide">
                                &nbsp;&nbsp;|&nbsp;&nbsp; </span><span class="em_br"></span><span
                    ...
                    <tr>
                        <td align="center"
                            ...
                            If you do not wish to receive any further emails from us, please <span
                                style="text-decoration:underline;"><a href="#" target="_blank"
                                    style="text-decoration:underline; color:#848789;">unsubscribe</a></span>
                        </td>
                    </tr>
                    <tr>
                        <td height="35" class="em_height">&nbsp;</td>
